...
function centro_servizi_archive_area_personale_assigned_terms(int $post_id): array
{
    $terms = get_the_terms($post_id, 'categoria-area-personale');
...
function centro_servizi_archive_area_personale_display_term(array $terms): ?WP_Term
{
    if ($terms === []) {
        return null;
    }
...
function centro_servizi_archive_area_personale_file_data(int $post_id): array
{
...
<main class="site-main" id="contenuto-principale" role="main">
    ...
    <ul>
        ...
        $allegato = centro_servizi_archive_area_personale_file_data($post_id);
        $termine_display = centro_servizi_archive_area_personale_display_term(centro_servizi_archive_area_personale_assigned_terms($post_id));
