...
<main class="site-main trasparenza-archive" id="contenuto-principale" role="main">
    <section class="site-section">
        <div class="site-section__inner">
            ...
            <div class="trasparenza-archive__layout">
                <aside class="trasparenza-archive__sidebar" aria-label="Filtri archivio area personale">
                    <form method="get" action="<?php echo esc_url($archive_url); ?>" class="trasparenza-filters">

                        <div class="trasparenza-filters__search">
                            <label for="area-personale-q">Cerca</label>
                            <input type="search" id="area-personale-q" name="q" value="<?php echo esc_attr($selected_search); ?>" placeholder="Cerca documento...">
                        </div>
    ...
    <ul class="trasparenza-archive__list">
        ...
        $terms_raw   = get_the_terms($post_id, 'categoria-area-personale');
        ...
        <li class="trasparenza-archive__item">
            <?php
            get_template_part('partials/card-area-personale', null, [
                'post_id'         => $post_id,
